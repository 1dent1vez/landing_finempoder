...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-[1200px] mx-auto px-6 py-16 lg:py-8">
        <div className="grid lg:grid-cols-2 gap-14 lg:gap-12 items-center">
          ...
          <div className="max-w-xl">
            ...
            <h1 className="mt-6 font-display leading-[1.04] tracking-tight">
              <span
                ref={headline1Ref}
                className="block text-[clamp(44px,6.5vw,88px)] font-black text-cacao opacity-0"
              >
                El dinero no se enseña en la escuela.
              </span>
              <span
                ref={headline2Ref}
                className="block mt-3 text-[clamp(24px,3.2vw,40px)] font-medium text-cacao/85 opacity-0"
              >
                Lo aprendemos aquí.
                <br />
            ...
            <p
              ref={subtitleRef}
              className="mt-8 font-body text-lg leading-relaxed text-cacao/90 max-w-[480px] opacity-0"
            >
            ...
            <div ref={ctaRef} className="mt-9 flex flex-wrap items-center gap-4 opacity-0">
              <Link
                to="/mantenimiento"
                className="inline-block font-display font-medium text-base bg-cacao text-crema px-8 py-4 rounded-full hover:bg-[#1f1420] hover:scale-[1.03] transition-all duration-300 shadow-lg"
              >
                Crear mi cuenta gratis
              </Link>
              <Link
                to="/mantenimiento"
                className="inline-block font-display font-medium text-base text-cacao border-2 border-cacao/50 bg-white/40 backdrop-blur-sm px-8 py-4 rounded-full hover:border-cacao/80 hover:bg-white/60 transition-all duration-300"
              >
                Explorar sin cuenta
              </Link>
            </div>
          ...
          {/* Phone Mockup Column */}
          <div ref={phoneRef} className="relative w-[290px] sm:w-[330px] mx-auto opacity-0">
            {/* Aura */}
            <div className="absolute -inset-10 bg-white/40 blur-3xl rounded-full" />

            {/* Phone frame */}
            <div className="relative bg-cacao rounded-[2.8rem] p-3 shadow-2xl rotate-2">
              <div className="mx-auto mb-2 w-24 h-6 bg-cacao rounded-full border border-white/10" />
              <div className="bg-crema rounded-[2.2rem] overflow-hidden">
                {/* App header */}
                <div className="px-5 pt-6 pb-2 flex items-center justify-between">
                  <span className="font-display font-bold text-[15px] text-cacao">
                    FinEmpoder
                  </span>
                  <span className="flex items-center gap-1.5 text-[11px] font-semibold text-cacao bg-mantequilla/70 px-2.5 py-1 rounded-full mt-1">
                ...
                {/* Tab bar */}
                <div className="mt-4 border-t border-cacao/10 bg-white/80 px-8 py-3 flex items-center justify-between">
            ...
            {/* Floating XP card */}
            <div className="absolute -left-12 top-36 bg-white rounded-xl shadow-lg px-3.5 py-2.5 flex items-center gap-2 rotate-[-6deg]">
        ...
        <div
          ref={statsRef}
          className="relative mt-16 lg:mt-20 -mb-16 lg:-mb-20 bg-white rounded-3xl shadow-xl px-6 py-6 grid grid-cols-3 divide-x divide-cacao/20 opacity-0"
        >
          <div className="text-center px-2">
            <p className="font-display font-black text-[clamp(28px,3.5vw,44px)] text-cacao leading-none">
              45
            </p>
